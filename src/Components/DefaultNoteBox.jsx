...
const DefaultNoteBox = () => {
  return (
    <main className="default-main" >
      <div style={{ width: "48vw", margin: "0 auto", marginTop: "50px" }}>
        <div style={{ width: "48vw", margin:'0 auto' }}>
          <img src={DefaultNoteimg}  alt=""  style={{ width:'48vw' }} />
        </div>
        <div>
          <h1
